...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        SimplificationContent content = DISCOURSE_SIMPLIFIER.doDiscourseSimplification(new File("E:/AAAWorkSpace/auto-KG/data/C2S_input.txt"), ProcessingType.SEPARATE, true);
        ...
        saveLines(new File("E:/AAAWorkSpace/auto-KG/data/C2S_output.txt"), Arrays.asList(content.flatFormat(false)));
        LOGGER.info("done");
    }
}
